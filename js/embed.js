            ...
            e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function (e) {
                ...
                render: function (e) {
                    ...
                    var g = i.el = H(et.replybox(h)).click(p), b = g.find("form"), y = b.find("input[type=checkbox]")[0], _ = b.find("a.ds-service-icon, a.ds-service-icon-grey"), k = f(b.find("textarea")).focus(p).keyup(n).keyup(d).bind("focus mousedown mouseup keyup", u), w = g.find(".ds-add-emote").click(function (e) {
                        ...
                        return w.toggleClass("ds-expanded").hasClass("ds-expanded") ? (s || (s = S.smiliesTooltip = new st.SmiliesTooltip, s.render(), DUOSHUO.addSmilies("(・ω・) 颜文字",{
                            "(*/ω＼*)":"","（￣▽￣）":"","(=・ω・=)":"","(｀・ω・´)":"","(〜￣△￣)〜":"","(･∀･)":"","(°∀°)ﾉ":"",
                            "(￣3￣)":"","╮(￣▽￣)╭":"","( ´_ゝ｀)":"","←_←":"","→_→":"","(<_<)":"","(>_>)":"","(;¬_¬)":"",
                            "(ﾟДﾟ≡ﾟдﾟ)!?":"","Σ(ﾟдﾟ;)":"","Σ( ￣□￣||)":"","(´；ω；`)":"","（/TДT)/":"",
                            "(^・ω・^ )":"","(｡･ω･｡)":"","(●￣(ｴ)￣●)":"","ε=ε=(ノ≧∇≦)ノ":"","(´･_･`)":"","(-_-#)":"",
                            "（￣へ￣）":"","(￣ε(#￣) Σ":"","ヽ(`Д´)ﾉ":"","(╯°口°)╯(┴—┴":"","（#-_-)┯━┯":"","_(:3」∠)_":"",
                            "龴ↀ◡ↀ龴":"","┌( ಠ_ಠ)┘":"","( ´╥ω╥`)":"","(⁄ ⁄•⁄ω⁄•⁄ ⁄)⁄":"","(づ￣ ³￣)づ":"","ಥ_ಥ":""
                        }),S.require("smilies", function () {
                            s.reset("微博-默认")
                ...
                render: function () {
                    ...
                    }), a.find(".ds-smilies-container").delegate("img", "click", e),a.find(".ds-smilies-container").delegate("p", "click", e), this
                }, reset: function (e) {
                    function t(t, s) {
